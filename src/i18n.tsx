...
const ua = {
  ...
  hero: {
    ...
    titleStart: 'Сайти та веб-додатки під ключ —',
    words: [
      'від ідеї до запуску',
      'швидко й прозоро',
      'із чистим кодом',
      'особисто, без агенцій',
    ],
    sub: 'Я Андрій, full-stack розробник із Києва. Проєктую, кодую і запускаю сучасні швидкі сайти особисто — у фіксований строк, із прозорим кодом і без зайвих витрат на агенції.',
    ctaPrimary: 'Написати в Telegram',
    ctaSecondary: 'Подивитися роботи',
    ctaNote: 'Відповідаю протягом кількох годин · Безкоштовна оцінка задачі',
    meta: ['Київ, Україна', 'UTC+2'],
    metaLink: 'Профіль на Freelancehunt',
    stats: ['технологій у стеку', 'напрями послуг', 'на звʼязку'],
  },
  marquee: [
    'JavaScript',
    'TypeScript',
  ...
  pricing: {
    label: '05 — Ціни',
    title: 'Прозорі пакети',
    sub: 'Орієнтовні суми «від». Точна оцінка під вашу задачу — безкоштовна й ні до чого не зобовʼязує.',
    popular: 'Популярне',
    cta: 'Обговорити',
    plans: [
      {
        name: 'Сайт / веб-додаток',
        price: 'від $150',
        desc: 'Лендінг, корпоративний сайт або веб-застосунок під ключ.',
        features: [
          'Адаптивна верстка під усі екрани',
          'Швидке завантаження + базове SEO',
          'Форма заявок або Telegram-інтеграція',
          'Чистий код + деплой',
        ],
        featured: true,
      },
      {
        name: 'Telegram-бот',
        price: 'від $100',
        desc: 'Бот, що приймає заявки, продає й відповідає клієнтам 24/7.',
        features: [
          'Сценарій діалогу під ваш бізнес',
          'Збір і валідація заявок',
          'Сповіщення менеджеру миттєво',
          'Інтеграції з CRM / таблицями',
        ],
        featured: false,
      },
      {
        name: 'Автоматизація',
        price: 'від $80',
        desc: 'Парсинг, інтеграції через API та скрипти для рутини.',
        features: [
          'Збір даних із сайтів',
          'Інтеграції через API',
          'Скрипти під рутинні задачі',
  ...
  faq: {
    ...
    items: [
      {
        q: 'У вас мало проєктів — чому вам можна довіряти?',
        a: 'Увесь мій код відкритий на GitHub — ви бачите якість ще до старту. Працюю за фіксованим кошторисом: обсяг і ціну фіксуємо до початку, тож ваш ризик мінімальний.',
      },
      {
        q: 'Скільки часу займе мій проєкт?',
        a: 'Лендінг — 1–2 тижні, сайт під ключ — 2–4 тижні, веб-додаток — за оцінкою. Точний строк фіксуємо до старту й розбиваємо на етапи.',
      },
      {
        q: 'Як відбувається оплата?',
        a: 'Поетапно: невелика передоплата → проміжне демо → фінальна оплата після запуску. Жодних повних передоплат наосліп.',
      },
      {
        q: 'Чи буде підтримка після запуску?',
        a: 'Так. Я не зникаю після здачі: доопрацювання, оновлення й підтримку обговорюємо окремо й прозоро.',
      },
      {
        q: 'Якою мовою спілкуємось і працюємо?',
        a: 'Українською або англійською — як вам зручніше. Інтерфейс і тексти теж можу зробити двомовними.',
      },
    ],
  },
  contact: {
...
const en: Dict = {
  ...
  hero: {
    ...
    titleStart: 'Turnkey websites & web apps —',
    words: [
      'from idea to launch',
      'fast and transparent',
      'with clean code',
      'directly, no agencies',
    ],
    sub: "I'm Andrii, a full-stack developer from Kyiv. I design, build and ship fast modern sites myself — on a fixed timeline, with transparent code and no agency overhead.",
    ctaPrimary: 'Message me on Telegram',
    ctaSecondary: 'View work',
    ctaNote: 'Replies within hours · Free project estimate',
    meta: ['Kyiv, Ukraine', 'UTC+2'],
    metaLink: 'Freelancehunt profile',
    stats: ['technologies in the stack', 'service areas', 'online'],
  },
  marquee: [
    'JavaScript',
    'TypeScript',
  ...
  pricing: {
    ...
    sub: 'Indicative "from" prices. A precise estimate for your task is free and with no obligation.',
    popular: 'Popular',
    cta: 'Discuss',
    plans: [
      {
        ...
        price: 'from $150',
        desc: 'Landing page, corporate site or web app — turnkey.',
        features: [
          'Responsive across all screens',
          'Fast loading + basic SEO',
          'Lead form or Telegram integration',
      ...
      },
      {
        name: 'Telegram bot',
        price: 'from $100',
        desc: 'A bot that captures leads, sells and replies 24/7.',
        features: [
          'Dialogue flow for your business',
      ...
      },
      {
        name: 'Automation',
        price: 'from $80',
        desc: 'Parsing, API integrations and scripts for routine work.',
        features: [
          'Data scraping from sites',
          'API integrations',
  ...
  faq: {
    ...
    items: [
      {
        q: 'You have few projects — why should I trust you?',
        a: 'All my code is open on GitHub — you see the quality before we start. I work on a fixed estimate: scope and price are locked upfront, so your risk is minimal.',
      },
      {
        q: 'How long will my project take?',
        a: 'Landing page — 1–2 weeks, turnkey site — 2–4 weeks, web app — by estimate. The exact timeline is fixed before the start and split into stages.',
      },
      {
        q: 'How does payment work?',
        a: 'In stages: a small upfront → an intermediate demo → final payment after launch. No blind full prepayments.',
      },
      {
        q: 'Is there support after launch?',
        a: "Yes. I don't disappear after delivery: improvements, updates and support are agreed separately and transparently.",
      },
      {
        q: 'What language do we communicate in?',
        a: 'Ukrainian or English — whatever suits you. The interface and copy can be bilingual too.',
      },
    ],
  },
  contact: {
